...
class CE_Net_(nn.Module):
    def __init__(self, num_classes=Constants.BINARY_CLASS, num_channels=3):
        ...
        self.inception1 = Inception(256)

        self.encoder2 = model.layer2
        self.inception2 = Inception(512)

        self.encoder3 = model.layer3
        self.inception3 = Inception(1024)
    ...
    def forward(self, x):
        ...
        e1 = self.encoder1(x)
        e11 = self.inception1(e1)

        e2 = self.encoder2(e11)
        e22 = self.inception2(e2)

        e3 = self.encoder3(e22)
        e33 = self.inception3(e3)
